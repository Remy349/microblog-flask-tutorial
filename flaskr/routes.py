...
def login():
    ...
    return render_template("forms/login.html", title=_("Sign In"), form=form)
...
def register():
    ...
    return render_template("forms/register.html", title=_("Register"), form=form)
...
def edit_user():
    ...
    return render_template("profile/edit_user.html", title=_("Edit Profile"),
                           form=form)
...
def reset_password_request():
    ...
    form = ResetPasswordResquestForm()
    ...
    return render_template("forms/reset_password_request.html", title=_("Reset Password"),
                           form=form)
